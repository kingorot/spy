...
export const SpyGuessPhase = ({
  ...
  if (!isSpy) {
    return (
      <div className="glass-panel p-6 rounded-2xl border border-rose-500/40 text-center space-y-3 shadow-xl">
  ...
  return (
    <div className="glass-panel p-5 rounded-2xl border border-rose-500/50 space-y-4 shadow-xl">
