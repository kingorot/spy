...
export const ClueTable = ({ clueLogs = [] }) => {
  ...
  return (
    <div className="glass-panel p-3.5 rounded-2xl border border-zinc-800 space-y-2 shadow-xl my-2">
      <h4 className="text-xs font-black uppercase tracking-wider text-zinc-300 flex items-center gap-1.5 border-b border-zinc-800 pb-1.5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
        {playerClues.map((clue, idx) => (
          <div
            key={idx}
            className="p-2 rounded-xl bg-zinc-900 border border-zinc-800 flex flex-col justify-between gap-1 shadow-sm"
          >
