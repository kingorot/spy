...
export const ClueTable = ({ clueLogs = [], players = [] }) => {
  ...
  // Group all player clues sequentially by senderName
  ...
  return (
    <div className="glass-panel p-3 rounded-2xl border border-zinc-800 shadow-2xl space-y-2 max-h-56 overflow-y-auto w-full">
