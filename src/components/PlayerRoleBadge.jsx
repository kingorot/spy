...
export default function PlayerRoleBadge({ myRole, myName }) {
  const isSpy = myRole === 'SPY';

  return (
    <div className="w-full max-w-4xl mx-auto mb-3">
      <div className={`
        w-full py-2.5 px-4 rounded-xl border flex items-center justify-center shadow-lg transition-all duration-300 font-mono select-none text-center
        ${isSpy
